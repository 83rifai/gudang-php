...
/* Kode_Barang */
/**/	$queryB = mysql_query("SELECT Kode_Barang, Nama_Barang FROM barang");
/**/
/**/	$option2 = '';
...
// barang
	$queryC = mysql_query("SELECT Kode_Barang, Nama_Barang FROM barang WHERE Kode_Barang LIKE 'BJ%'");
	
	$barang = '';
	while($dtC= mysql_fetch_array($queryC)){
		$barang .= "<input type='checkbox' id='".$dtC['Kode_Barang']."' name='Kode_Barang' value='".$dtC['Kode_Barang']."' onclick='tampil(this.id)'>
					<label for='".$dtC['Kode_Barang']."'>".$dtC['Nama_Barang']."</label>
					";
	}
// barang
...
session_start();
	...
	<form action="" method="POST" onsubmit="return validate()">
		...
		<table border="1" align="center">
			...
			<tr>	
				<td colspan="4" align="center"><input type="submit" value="ok" style="width:100%" /></td>
			</tr>
	</table>
	</form>	
