	...
	<form action="" method="POST" onsubmit="return validate()">
		...
		<table border="1" align="center">
			...
			<tr>
				...
				<td align="left">
					<select name="id_customer" id="id_customer" style="width:166px">
						'.$option1.'
					</select>
				</td>
			</tr>
		...
		<tr></tr>
			...
			<tr>			
				...
				<td align="left"><input type="text" name="No_Produksi[]" class="avoid-clicks" maxlength="10" value="'.$dt_count7[0].'"/></td> 
			...
			<tr>			
				<td align="left"><input type="text" name="Kode_Barang[]"/></td> 
				<td align="left"><input type="text" name="No_Produksi[]" class="avoid-clicks" maxlength="10" value="'.$dt_count7.'"/></td> 
				<td align="left"><input type="text" name="PO_Item[]"/></td> 
				<td align="left"><input type="text" name="Tanggal_Pengiriman[]" class="datepicker"/></td> 
				<td align="left"><input type="text"name="Qty[]"/></td> 
				<td align="left"><input type="text"name="Satuan[]"/></td>
			...
			<tr>			
				<td align="left"><input type="text" name="Kode_Barang[]"class="avoid-clicks"/></td> 
				<td align="left"><input type="text" name="No_Produksi[]" class="avoid-clicks" maxlength="10" value="'.$dt_count7.'"/></td> 
				<td align="left"><input type="text" name="PO_Item[]"/></td> 
				<td align="left"><input type="text" name="Tanggal_Pengiriman[]" class="datepicker"/></td> 
				<td align="left"><input type="text"name="Qty[]"/></td> 
